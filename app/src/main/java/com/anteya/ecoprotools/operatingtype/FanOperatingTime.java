 ...
 */
public class FanOperatingTime {

    public static final int F1Mode_DefaultTurnOnTime = 0;
    public static final int F1Mode_DefaultTurnOffTime = 0;

    public static final int F2Mode_DefaultTurnOnTime = 0;
