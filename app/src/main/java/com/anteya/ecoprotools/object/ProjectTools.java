...
public class ProjectTools {
    ...
    public static final byte[] COMMAND_POLLING = new byte[]{(byte) 0xf0, (byte)0x01, (byte)0x71};

    // 停止, command 已經經過 Checksum 計算
    public static final byte[] COMMAND_CHANGE_MODE_0 = new byte[]{(byte) 0xf0, (byte)0x02, (byte)0x00, (byte)0x72};
    // F1 育苗, command 已經經過 Checksum 計算
    public static final byte[] COMMAND_CHANGE_MODE_1 = new byte[]{(byte) 0xf0, (byte)0x02, (byte)0x01, (byte)0x73};
    // F2 生長, command 已經經過 Checksum 計算
    public static final byte[] COMMAND_CHANGE_MODE_2 = new byte[]{(byte) 0xf0, (byte)0x02, (byte)0x02, (byte)0x74};
    // F3 開花, command 已經經過 Checksum 計算
    public static final byte[] COMMAND_CHANGE_MODE_3 = new byte[]{(byte) 0xf0, (byte)0x02, (byte)0x03, (byte)0x75};
    // 手動, command 已經經過 Checksum 計算
    public static final byte[] COMMAND_CHANGE_MODE_4 = new byte[]{(byte) 0xf0, (byte)0x02, (byte)0x04, (byte)0x76};
